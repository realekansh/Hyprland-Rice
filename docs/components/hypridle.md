...
| **180s** (3m) | Dim Screen | `brightnessctl -s set 50` | `brightnessctl -r` (restores brightness) |
| **180s** (3m) | Keyboard Backlight | `brightnessctl -sd rgb:kbd_backlight set 0` | `brightnessctl -rd rgb:kbd_backlight` |
