...
local terminal    = executable("/usr/bin/kitty") or executable("/usr/bin/alacritty")
local fileManager = executable("/usr/bin/nautilus") or executable("/usr/bin/thunar")
local browser     = executable("/usr/bin/firefox") or executable("/usr/bin/chromium") or executable("/usr/bin/google-chrome-stable") or executable("/usr/bin/brave")
...
local hyprcaffeine = executable("/usr/bin/hyprcaffeine")
...
if hyprcaffeine then
  hl.bind("SUPER + CTRL + I", hl.dsp.exec_cmd(hyprcaffeine .. " toggle"))
  hl.bind("SUPER + CTRL + SHIFT + I", hl.dsp.exec_cmd(hyprcaffeine .. " menu"))
  hl.bind("SUPER + CTRL + SHIFT + D", hl.dsp.exec_cmd(hyprcaffeine .. " lid toggle"))
  hl.bind("SUPER + CTRL + D", hl.dsp.exec_cmd(hyprcaffeine .. " monitor toggle"))
end
